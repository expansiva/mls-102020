/// <mls fileReference="_102020_/l1/agentMaterializeL2/core.ts" enhancement="_blank"/>

// Pure materialization core for L2 frontend (.defs.ts -> .ts). It has no fs, no mls.* and no DOM
// dependency so the Node runner and the future Studio agent can reuse the same parser, ordering,
// staleness and prompt assembly rules.
