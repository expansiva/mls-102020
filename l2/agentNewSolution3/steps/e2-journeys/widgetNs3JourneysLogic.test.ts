/// <mls fileReference="_102020_/l2/agentNewSolution3/steps/e2-journeys/widgetNs3JourneysLogic.test.ts" enhancement="_blank"/>
...
import type { Ns3E2JourneysArtifact } from '/_102020_/l2/agentNewSolution3/steps/e2-journeys/gate.js';
import {
  applyNs3JourneysWidgetEdits,
...
test('journey widget edits build a proposed artifact without mutating the source', () => {
  ...
  const proposed = applyNs3JourneysWidgetEdits(artifact, edits);
...
test('journey review payload follows the checkpoint contract', () => {
  ...
  const payload = buildNs3JourneysReviewPayload({
    artifact,
    action: 'adjust',
