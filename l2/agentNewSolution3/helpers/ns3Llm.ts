/// <mls fileReference="_102020_/l2/agentNewSolution3/helpers/ns3Llm.ts" enhancement="_blank"/>

// Generic LLM tool-call payload handling for ns3 steps. Policy: this helper is
...
export type Ns3ToolStatus = 'ok' | 'failed';

export interface Ns3ToolOutput {
  status: Ns3ToolStatus;
  result: Record<string, unknown>;
  trace: string[];
}

export function createNs3ToolSchema(
  toolName: string,
  description: string,
...
export function buildNs3ToolInstruction(toolName: string, failedWhen: string): string {
  return `
...
export function extractNs3ToolOutput(payload: unknown, toolName: string): Ns3ToolOutput {
...
function tryExtractToolWrapper(value: unknown, toolName: string): Ns3ToolOutput | null {
...
function normalizeToolArguments(value: unknown, toolName: string, depth = 0): Ns3ToolOutput {
...
function tryExtractOpenAiToolCall(value: unknown, toolName: string): Ns3ToolOutput | null {
...
function tryNormalizeEnvelope(value: unknown, toolName: string): Ns3ToolOutput | null {
...
function normalizeStatus(value: unknown): Ns3ToolStatus {
