...
// agentSelectVariant2). Writes `groupSelections` to the page defs for Agent2 to consume.
...
/** The intermediate handoff: which groups each organism needs (consumed by agentSelectVariant2). */
function buildGroupSelectionsDefs(defsRef: string, perOrganism: unknown): string {
  ...
  return [
    ...
    '',
    '// Generated by agentSelectGroups2 (Agent1). Groups chosen per organism.',
    '// Consumed by agentSelectVariant2 (Agent2), which picks the concrete molecule variant.',
    '',
