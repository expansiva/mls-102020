...
> **Atualização 2026-07-15 (create-page):** o fluxo separa `scan-create-l4 -> create-contract-shared-fanout -> create-layout-fanout -> reconcile-shared-fanout -> verify-create-layouts -> materialize-create-l2`. O scan lê L4 uma vez; cada chamada LLM produz somente um layout para um template pinado. Filhos de fan-out sempre concluem com trace; a validação estrita de `page11` ocorre no gate sequencial posterior.
