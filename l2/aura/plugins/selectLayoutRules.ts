/// <mls fileReference="_102020_/l2/aura/plugins/selectLayoutRules.ts" enhancement="_102027_/l2/enhancementLit.ts"/>
...
@customElement('aura--plugins--select-layout-rules-102020')
export class PluginSelectLayoutRules extends StateLitElement {
    ...
    private get _visibleSections(): ILayoutSection[] {
        if (this._isBaseScope) return layoutSections.filter(s => s.primary || this._addedSections.has(s.key));
