...
import {
  parseTplArgs, templateRef, workspaceRef, readFile, saveTextArtifact, buildFileSystemPrompt,
  buildLabelledHuman, extractFileContent, TPL_FILE_TOOL, TPL_FILE_TOOL_NAME,
...
async function beforePromptStep(
  ...
  try {
    ...
    const continueParallel: mls.msg.AgentIntentPromptReady = {
      ...
      systemPrompt: buildFileSystemPrompt(writeTemplateSkill, 'code', outPath),
      humanPrompt,
