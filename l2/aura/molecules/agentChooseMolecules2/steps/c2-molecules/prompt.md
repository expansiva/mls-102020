...
A component the catalog marks as being outside the contract (no `.defs.ts`) can still be the right choice. If you choose it, **repeat the limitation in the reason**.
