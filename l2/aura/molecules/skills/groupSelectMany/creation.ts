...
| 1.3.0 | 2026-07-17 | Portal hardening — \`portalWidgetName\` must be the molecule's OWN tag (removed real-tag example); portal CSS block documented as top-level, never nested |
