/// <mls fileReference="_102020_/l2/aura/molecules/skills/groupEnterNumberInterval/usage.ts" enhancement="_blank"/>
...
\`\`\`css
.my-container {
  --ml-focus-ring-error-color: rgba(239, 68, 68, 0.4);
  --ml-error: #ef4444;
...
| \`--ml-focus-ring-error-color\` | \`rgba(239, 68, 68, 0.4)\` | Focus ring color in error state |
