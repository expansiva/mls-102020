/// <mls fileReference="_102020_/l2/aura/molecules/skills/groupEnterBoolean/creation.ts" enhancement="_blank"/>
...
| Class | Purpose |
|-------|---------|
| ml-toggle-track | Toggle track (background, border, radius, focus ring) |
| ml-toggle-track-on | Track active/on state |
| ml-toggle-track-error | Track error state |
| ml-toggle-thumb | Toggle thumb (background, radius, shadow) |
| ml-label | Field label |
| ml-helper | Helper text |
| ml-error-text | Error message |
| ml-text | Default text (view mode) |
