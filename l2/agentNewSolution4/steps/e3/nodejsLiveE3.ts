/// <mls fileReference="_102020_/l2/agentNewSolution4/steps/e3/nodejsLiveE3.ts" enhancement="_blank"/>
...
async function main(): Promise<void> {
  ...
  const [moduleSource, journeysSource, promptTemplate, platformSkill] = await Promise.all([
    ...
    readFile(path.join(ROOT, 'mls-102020/l2/agentNewSolution4/steps/e3/prompt.md'), 'utf8'),
  ...
  try {
    const response = await fetch(`${config.baseUrl.replace(/\/+$/, '')}/v1/chat/completions`, {
      ...
      headers: {
        ...
        'X-Title': 'agentNewSolution4 E3 live test', 'X-Collab-Origin': 'agentNewSolution4',
