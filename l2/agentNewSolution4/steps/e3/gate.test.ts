...
const journeys = normalizeNs4E2Review({
  ...
  journeys: [{
    ...
    business: {
      ...
      outcome: { statement: 'Projeto disponível.', evidence: ['Projeto identificado.'] }, businessRules: [],
    },
  }],
  ...
  grants: [
    {
      ...
      disclosure: { mode: 'fullRecord', description: 'Registro operacional do projeto.', allowedInformation: [], deniedInformation: [] }, constraints: [],
    },
    {
      ...
      constraints: ['Validar a associação no backend.'],
    },
  ],
