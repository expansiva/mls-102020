/// <mls fileReference="_102020_/l2/agentNewSolution4/steps/e6/agentNs4E6.ts" enhancement="_102027_/l2/enhancementAgent"/>
...
import { Ns4RulesArtifact } from '/_102020_/l2/agentNewSolution4/steps/e5/contracts.js';
import {
...
export async function beforeNs4E6PromptStep(
  ...
  if (!context.task) throw new Error('[agentNewSolution4:e6] task invalid');
  let moduleName = '';
  try {
...
export async function beforeNs4E6ClarificationStep(
  ...
  await import('/_102020_/l2/agentNewSolution4/widgets/widgetNs4Composition.js');
