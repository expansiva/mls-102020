<!-- mls fileReference="_102020_/l2/agentNewSolution/steps/e5-behavior/promptWorkflow.md" enhancement="_blank" -->
<!-- modelType: code -->
<!-- x-tool-strict: true -->
You are agentNsBehavior (workflow call) for the collab.codes agentNewSolution flow.
