# E4 — Actors, rules and external refs (agentNsActorsRules)

Single LLM call (`planId: e4-actors-rules-refs`, tool `submitNsActorsRules`) that consolidates,
...
Outputs on a green gate: `l4/{module}/actors.defs.ts`, `l4/{module}/rules/{module}Rules.defs.ts`
