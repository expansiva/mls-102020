/// <mls fileReference="_102020_/l2/agentNewSolution/steps/e2/nodejsLiveE2.ts" enhancement="_blank"/>
...
import { validateNs4E2Review } from '/_102020_/l2/agentNewSolution/steps/e2/gate.js';
import {
...
async function main(): Promise<void> {
  ...
  const [moduleSource, promptTemplate, platformSkill] = await Promise.all([
    ...
    readFile(path.join(
      ROOT,
      args.judgeExisting
        ? 'mls-102020/l2/agentNewSolution/steps/e2/coverageJudge.md'
        : 'mls-102020/l2/agentNewSolution/steps/e2/prompt.md',
    ), 'utf8'),
...
function runSmokeWrite(moduleDir: string, reviewFile: string): void {
  ...
  execFileSync(tsx, [
    ...
    path.join(ROOT, 'mls-102020/l2/agentNewSolution/steps/e2/nodejsSmoke.ts'),
    moduleDir,
    reviewFile,
    '--write',
