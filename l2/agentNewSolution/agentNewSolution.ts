...
export const NS_AGENT_BUILD = 'build-23 (2026-07-21) e5-operation: entity field catalog in prompt + drop misleading Shift.shiftId example (fix contextResolution originRef inventing fields)';
