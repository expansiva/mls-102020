...
import { NS4_PERMANENT_ARTIFACT_TYPE_NAMES } from '/_102020_/l2/agentNewSolution/types.js';
...
test('permanent defs emitter imports the canonical type and uses as const satisfies', () => {
  ...
  assert.match(source, /import type \{ Ns4ModuleArtifact \} from '\/_102020_\/l2\/agentNewSolution\/types\.js';/);
