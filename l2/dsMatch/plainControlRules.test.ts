/// <mls fileReference="_102020_/l2/dsMatch/plainControlRules.test.ts" enhancement="_blank" />

// Tests for axesForGroup / rulesForPlainElement (pure). Exposes `runPlainControlRulesTests()`.

import { axesForGroup, rulesForPlainElement } from '/_102020_/l2/dsMatch/plainControlRules.js';
